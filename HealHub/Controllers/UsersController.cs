...
namespace HealHub.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
              return _context.userList != null ? 
                          View(await _context.userList.ToListAsync()) :
                          Problem("Entity set 'OracleDBContext.userList'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'OracleDBContext.userList'  is null.");
            }
            var user = await _context.userList.FindAsync(id);
            if (user != null)
            {
